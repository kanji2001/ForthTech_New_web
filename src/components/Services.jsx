...
export default function Services() {
  ...
  return (
    <div className="w-full min-h-screen" /* id="smooth-wrapper" ref={scrollRef} overflow-hidden h-screen */>
      <div className="bg-background-gray min-h-screen flex flex-col items-center justify-center text-text-black px-6 sm:px-10 py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 md:gap-20 md:gap-x-10 mt-30 max-w-6xl w-full px-2">
          {[ 
            ...
            <div
              key={index}
              className="card bg-background-light-black text-white p-6 rounded-xl shadow-lg flex flex-col justify-between w-full h-[300px] sm:h-[320px] relative transition-all"
