...
export default function PortfolioDetail() {
    ...
    return (
        <div className="max-w-[1200px] mx-auto bg-white">
            ...
            <div className="container mx-auto py-10 px-5">
                <h1 className="text-6xl font-bold mb-1">{project.title}</h1>
                <h6 className='text-3xl font-medium mb-4'>{project.title2}</h6>
            ...
            <div className="container mx-auto grid md:grid-cols-2 gap-15 py-10 px-5 items-center">
    ...
    <div className="grid grid-cols-2 gap-2">
        <img
            src={project.image5}
            alt={project.title}
            className="w-full h-auto max-w-[180px] lg:max-w-[250px] rounded-lg object-contain"
        />
        <img
            src={project.image6}
            alt={project.title}
    ...
    <div>
        ...
        <p className="text-justify mt-3">{project.sec5FirstP}</p>
            ...
            <div className="container mx-auto grid md:grid-cols-2 gap-10 py-10 px-5 items-center">
                ...
                <div className="grid grid-cols-2 gap-2">
                    <img
                        src={project.image9}
                        alt={project.title}
                        className="w-full h-40 md:h-70 object-cover rounded-lg"
                    />
                    <img
                        src={project.image10}
                        alt={project.title}
            ...
            {/* section 7 */}
            <div className="container w-full h-[500px] sm:h-[600px] md:h-[700px] lg:h-[800px] flex justify-center items-center ">
                <img
                    src={project.image13}
                    alt={project.title}
            ...
            <div className="container mx-auto grid md:grid-cols-1  py-10 px-5 items-center">
